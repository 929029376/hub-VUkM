...
async def get_model_response2(prompt, model_name, use_tool):
    ...
    tool_mcp_tools_filter: ToolFilterStatic = ToolFilterStatic(allowed_tool_names=["get_city_weather", "sentiment_classification","query_annual_leave",
                                                                                   "query_meeting_room","calculate_workdays"])
